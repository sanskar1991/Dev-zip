...
def write_rels(dict_3, files1):
    ...
    tree.write(f'{output_path}/ppt/_rels/presentation2.xml.rels', pretty_print=True, xml_declaration=True, encoding='UTF-8', standalone=True)
    ...
    tree.write(f'{output_path}/ppt/_rels/presentation1.xml.rels', pretty_print=True, xml_declaration=True, encoding='UTF-8', standalone=True)
...
def deck_handler(id, msg, deck, dict_2):
    ...
    # getting a list of assets which needs to be copied
...
if __name__ == '__main__':
    ...
    # sample_msg = [41, {'d': 'Presentation1', 's':  [1]}, {'d': 'Onboarding', 's':  None}]
